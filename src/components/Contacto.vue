...
<template>
    <div class="p-10 bg-gradient-to-r from-slate-900 from-10% via-sky-900 via-40% to-cyan-900 to-100% ">
        ...
        <div class="grid mt-10 lg:grid-cols-4 md:grid-cols-2 md:gap-7 md:ml-20 gap-4 lg:gap-36">
            ...
            <div class="">
                <a href="https://github.com/Luisrubin55" class="flex items-center gap-4">
                    <img class="w-20 bg-white rounded-full animate-pulse" src="/img/icons/github-color.svg" alt="">
                    <p class="text-white font-bold text-xl hover:text-emerald-400 transition delay-75">GitHub</p>
                </a>
            </div>
        </div>
